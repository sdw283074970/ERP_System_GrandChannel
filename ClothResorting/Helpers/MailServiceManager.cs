...
namespace ClothResorting.Helpers
{
    public class MailServiceManager
    {
        ...
        public void SendMailFromUSPRIME(string tomMail, string replyTo, string cc, string file_Path, string subject)
        {
            //实例化一个发送邮件类。
            MailMessage mailMessage = new MailMessage();
            ...
            mailMessage.Subject = subject;
            //邮件内容。
            mailMessage.Body = "This mail is sent by USPRIME automatically. Please see the attachment.";
