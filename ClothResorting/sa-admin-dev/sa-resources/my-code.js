...
// 设置模板标题 
sp.title = "Grand Channel";
sp.logo_url = '/Img/grandchannel_small.png';    // 设置logo图标地址   默认值：sa-resources/admin-logo.png
sp.icon_url = '/Img/grandchannel_small.png';    // 设置icon图标地址   默认值：sa-resources/admin-logo.png
...
sp.user = {
	username: 'root',	// 昵称 
	avatar: 'Img/grandchannel_small.png'	// 头像地址  
}
...
sp.dropList = [		// 头像点击处可操作的选项
	...
	},
	{
		...
		click: function() {
			...
			// location="login.html";
			layer.confirm('Log off？', function(res) {
