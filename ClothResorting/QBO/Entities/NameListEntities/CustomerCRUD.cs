...
using System.Linq;
using ClothResorting.QBO.BigHelper;

namespace ClothResorting.QBO.Entities.NameListEntities
{
    public class CustomerCRUD
    {
        ...
        public IList<Customer> CustomerFindAllTestUsingoAuth(ServiceContext qboContextoAuth)
        {
